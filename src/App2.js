...
import { C3 } from './app/components/C3';

import FunTestES5 from './app/components/FunTest';
...
class App extends Component {
  ...
  change = () => {
    this.setState({ flag: !this.state.flag, list: { firstName: 'Hcl', lastName: 'Tech' } });
  }
  render() {
    let divTest;
            ...
            <div className="row">
              ...
              <div className="col-lg-9 col-md-9 col-sm-9">
                <Switch >
                  ...
                  <Route path="/context" component={C3} />

                  <Route path="/function" component={FunTestES5} />
